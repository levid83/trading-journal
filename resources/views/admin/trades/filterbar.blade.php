<div class="col-md-3">
    <div class="form-group">
        <label for="filter_status" class="col-md-5 control-label">{{ 'Status' }}</label>
        <div class="col-md-7">
    ...
    <div class="form-group">
        <label for="filter_trader_id" class="col-md-5 control-label">{{ 'Trader' }}</label>
        <div class="col-md-7">
    ...
    <div class="form-group">
        <label for="filter_client_id" class="col-md-5 control-label">{{ 'Client' }}</label>
        <div class="col-md-7">
...
<div class="col-md-3">
    <div class="form-group">
        <label for="filter_underlying" class="col-md-3 control-label">{{ 'Underlying' }}</label>
        <div class="col-md-9">
            <input class="form-control" name="filter_underlying" type="text" id="filter_underlying" value="{{ old('filter_underlying')}}" title="Use commas to search more underlyings at once">
        </div>
    </div>

    <div class="form-group">
        <label for="filter_position_id" class="col-md-3 control-label">{{ 'Position Id' }}</label>
        <div class="col-md-9">
    ...
    <div class="form-group">
        <label for="filter_tactic_id" class="col-md-3 control-label">{{ 'Tactic' }}</label>
        <div class="col-md-9">
...
<div class="col-md-2">
    <div class="form-group">
        <label for="filter_asset_class" class="col-md-5 control-label">{{ 'Asset Class' }}</label>
        <div class="col-md-7">
    ...
    <div class="form-group">
        <label for="filter_action" class="col-md-5 control-label">{{ 'Action' }}</label>
        <div class="col-md-7">
    ...
    <div class="form-group">
        <label for="filter_strike" class="col-md-5 control-label">{{ 'Strike' }}</label>
        <div class="col-md-7">
            <input class="form-control" name="filter_strike" type="text" id="filter_strike" value="{{ old('filter_strike')}}" >
        </div>
    </div>
    <div class="form-group">
        <label for="filter_put_call" class="col-md-5 control-label">{{ 'Put Call' }}</label>
        <div class="col-md-7">
